 ...
 */
export default function CallbackType<Argument, Valid extends Argument, Msg>(value: Argument, callback: (value: Argument) => value is Valid, messsage: Function<[Return<Argument, Valid, Msg>], Msg>): Return<Argument, Valid, Msg>;
export {};
